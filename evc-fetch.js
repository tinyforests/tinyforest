...
<head>
  ...
  <title>Find & Grow My Ecological Garden | Gardener & Son</title>
  <!-- Fonts & Leaflet CSS -->
  <link
  ...
  <style>
    * {
    ...
    #nav-modal {
      ...
      width: 100%;
      height: 100%;
      background-color: rgba(61, 69, 53, 0.98);
      z-index: 9999;
      justify-content: center;
      align-items: center;
...
<body>
  ...
  <section id="section-1" class="page-section">
    <h2 id="page-title">Find & Grow My Ecological Garden.</h2>
    <button class="scroll-button" onclick="scrollToSection('section-2')">Find Out Why</button>
  </section>

  <!-- Section 2: Why -->
  <section id="section-2" class="page-section">
    <p class="hero-highlight">
      Indigenous plants have grown in harmony with local soils, climate, and wildlife for countless generations, yet have often been lost to development and introduced plants.<br>
By planting indigenous species, you help restore local biodiversity, support native wildlife, and build climate resilience right from your own garden.
    </p>
    <button class="scroll-button" onclick="scrollToSection('section-3')">Find Your Ecological Garden</button>
  </section>

  <!-- Section 3: Search -->
  <section id="section-3" class="page-section">
    <p>
      Enter your address to discover your Ecological Vegetation Class (EVC) and find what plants belong in your garden.
    </p>
  ...
  <div id="evc-modal">
    <div class="modal-content">
      ...
      <div id="modal-info">
        <p class="title">Your Ecological Garden is at <span id="modal-address"></span>:</p>
  ...
  <script>
    ...
    // Handle nav links (placeholder for now)
    document.querySelectorAll('.nav-content a').forEach(link => {
      link.addEventListener('click', (e) => {
        ...
        if (href === '#about') {
          alert('About page coming soon! This will showcase the mission of restoring ecological vegetation in Melbourne gardens.');
        } else if (href === '#contact') {
          alert('Contact: hello@gardenerandson.com\n\nGet in touch for garden consultations, plant kit orders, or ecological restoration projects.');
        }
      });
    });
  </script>
